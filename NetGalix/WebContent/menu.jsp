...
<body>
	...
	<div id="Layer2">
	<h:form>
	<h:commandLink action="#{perfilBean.zerarMensagem}" value="Faça seu Login ou cadastre-se" /> 
	...
	<div id="Layer3">
	<p class="carrinho"><strong><h:outputText value="#{perfilBean.mensagemInicial_2}"/></strong>,<h:outputText value="#{perfilBean.mensagemInicial}"/> <br /><br />
	...
	<div id="Layer6">
		...
		<div align="right"><input name="CampoBuscar" type="text"
			id="CampoBuscar" value="Buscar" onmouseover="if(this.value == 'Buscar')this.value='';" onmouseout="if(this.value == '')this.value='Buscar';" />
